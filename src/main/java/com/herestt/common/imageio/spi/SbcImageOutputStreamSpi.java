...
public class SbcImageOutputStreamSpi extends ImageOutputStreamSpi {
...
private static final String vendorName = "Herestt";
	...
	public SbcImageOutputStreamSpi() {
	...
	public ImageOutputStream createOutputStreamInstance(Object output,
		...
		try {
			return new PathImageOutputStream((SeekableByteChannel) output);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public String getDescription(Locale locale) {
		return "Service provider that instantiates a PathImageOutputStream from a SeekableByteChannel.";
	}
}